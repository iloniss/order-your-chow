...
namespace FileProcessor.Tests.Data
{
    public class Directory
    {
        ...
        public static string GetDirectory() => AppContext.BaseDirectory.Substring(0, AppContext.BaseDirectory.IndexOf("bin"));
        ...
        public static void CreateTestDirectory()
        {
            if (!System.IO.Directory.Exists(_projectDirectory + "/wwwroot"))
            {
                ...
                System.IO.File.Copy(GetDirectory() + @"\TestImages\69c42771-522b-4c33-b550-99685ec8b898.jpg", _projectDirectory + @"\wwwroot\images\products\69c42771-522b-4c33-b550-99685ec8b898.jpg");
                System.IO.File.Copy(GetDirectory() + @"\TestImages\d8155945-45c8-49da-90e6-e5604bf85e3f.jpg", _projectDirectory + @"\wwwroot\images\recipes\d8155945-45c8-49da-90e6-e5604bf85e3f.jpg");
            }
        }
    }
}