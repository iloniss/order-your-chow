...
namespace OrderYourChow.DAL.CORE.Migrations
{
    ...
    [Migration("20220123190158_DecimalMultiplierFix")]
    partial class DecimalMultiplierFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DDietDay", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DDietDayRecipe", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DPlan", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DPlanRecipe", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DRecipe", b =>
                {
                    b.Property<int>("RecipeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DRecipeImage", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DRecipeProduct", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DShopping", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DShoppingList", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.SDateDay", b =>
                {
                    b.Property<int>("DateDayId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.SDay", b =>
                {
                    b.Property<int>("DayId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.SProduct", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.SProductCategory", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.SProductMeasure", b =>
                {
                    b.Property<int>("ProductMeasureId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.SRecipeCategory", b =>
                {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.SWeek", b =>
                {
                    b.Property<int>("WeekId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DDietDay", b =>
                {
                    b.HasOne("OrderYourChow.DAL.CORE.SDateDay", "SDateDay")
                        .WithMany("DDietDays")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DPlan", b =>
                {
                    b.HasOne("OrderYourChow.DAL.CORE.SWeek", "Week")
                        .WithMany("DPlans")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DPlanRecipe", b =>
                {
                    b.HasOne("OrderYourChow.DAL.CORE.SDay", "Day")
                        .WithMany("DPlanRecipes")
                        .HasForeignKey("DayId")
                        .HasConstraintName("FK__D_PLAN_RE__DayId__00200768")
                        .IsRequired();

                    b.HasOne("OrderYourChow.DAL.CORE.DRecipe", "Recipe")
                        .WithMany("DPlanRecipes")
                        .HasForeignKey("RecipeId")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DRecipe", b =>
                {
                    b.HasOne("OrderYourChow.DAL.CORE.SRecipeCategory", "Category")
                        .WithMany("DRecipes")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DRecipeProduct", b =>
                {
                    b.HasOne("OrderYourChow.DAL.CORE.SProduct", "Product")
                        .WithMany("DRecipeProducts")
                        .HasForeignKey("ProductId")
                        .HasConstraintName("FK__D_RECIPE___Produ__05D8E0BE")
                        .IsRequired();

                    b.HasOne("OrderYourChow.DAL.CORE.SProductMeasure", "ProductMeasure")
                        .WithMany("DRecipeProducts")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.DShoppingList", b =>
                {
                    ...
                    b.HasOne("OrderYourChow.DAL.CORE.DShopping", "Shopping")
                        .WithMany("DShoppingLists")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.SDateDay", b =>
                {
                    b.HasOne("OrderYourChow.DAL.CORE.SDay", "SDay")
                        .WithMany("SDateDays")
                        .HasForeignKey("DayId")
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.SProduct", b =>
                {
                    b.HasOne("OrderYourChow.DAL.CORE.SProductCategory", "Category")
                        .WithMany("SProducts")
                        .HasForeignKey("CategoryId")
