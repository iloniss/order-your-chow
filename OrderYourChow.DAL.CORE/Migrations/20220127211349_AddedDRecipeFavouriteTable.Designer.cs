...
namespace OrderYourChow.DAL.CORE.Migrations
{
    ...
    [Migration("20220127211349_AddedDRecipeFavouriteTable")]
    partial class AddedDRecipeFavouriteTable
    {
            ...
            modelBuilder.Entity("OrderYourChow.DAL.CORE.Models.DRecipeFavourite", b =>
                {
                    ...
                    b.HasKey("RecipeFavouriteId")
                        .HasName("PK__D_RECIPFAVOURITE_RecipeFavouriteId");

                    b.ToTable("D_RECIPFAVOURITE");
                });
